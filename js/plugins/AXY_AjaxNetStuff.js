...
//=============================================================================
/*:
 * @plugindesc v1.64 This plugin support rmmv with ajax net stuff.
...
if (AXY.AjaxNetStuff.Param.AppID > 0) {
	AXY.AjaxNetStuff.Variables.URL = 'https://666rpg.com/game/detail/id/' + AXY.AjaxNetStuff.Param.AppID;
} else {
