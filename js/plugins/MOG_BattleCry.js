 ...
 * (在战斗中添加声音(动作、伤害、胜利等)来定义声音需要手动编辑插件)
...
　　var Moghunter = Moghunter || {}; 	
	...
	// -----------------------------------------------------------------------
	// ACTOR - DEFAULT ACTION (Skill/ITEM) (默认活动(技能/物品))
	// -----------------------------------------------------------------------		
