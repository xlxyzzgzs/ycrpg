...
/*:
 * @plugindesc (v2.4 *) Apresenta um medidor de HP para os chefes.(它为Boss提供了一个HP表。)
 * @author Moghunter
 *
 * @param Shake Effect
 ...
 * (要设置HP仪表的位置，请通过PLUGIN COMMAND命令使用以下注释)
 * 
 ...
 * comando PLUGIN COMMAND.
 * (要隐藏或显示HP值，请使用PLUGIN COMMAND命令使用以下注释)
 *
 * boss_hp_number_hide
 * boss_hp_number_show
 *
