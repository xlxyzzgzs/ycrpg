//=============================================================================
// SF_PictureGallery.js
//=============================================================================

/*:
 * ~struct~PictureSamary
 * 
 * @param FileName
 * @type file
 * @dir img/PictureGallery
 * @desc Picture File Location
 * @require 1
 * 
 * @param Picture Nmae
 * @type text
 * @desc Picture Name showed in game
 * 
 * @param Picture Info
 * @type note
 * @desc Shows in info window when Picture selected
 * 
*/

/*:
 * @plugindesc change from MOG_PictureGallery
 * @author Moghunter , SF
 *
 * @param Pictures Info
 * @desc define Picture Info
 * @type struct<PictureSamary>[]
 *
 * @param Command Menu
 * @desc show this command in Main Menu
 * @type boolean
 * @default true
 *
 * @param Command Word
 * @desc Command Name Show in Main Menu
 * @type text
 * @default Picture Gallery
 *
 * @param Completion Word
 * @desc Completion word in Scene Gallery
 * %1 : enabled number
 * %2 : total number
 * %3 : enable rate
 * @type text
 * @default Completion %1 / %2 
 *
 * @param Thumbnails For Line
 * @desc Pic Numbers per line
 * @type number
 * @default 3
 * 
 * @param Thumbnail X-Axis
 * @desc Thumbnail x-Axis offset position
 * @type number
 * @default 23
 *
 * @param Thumbnail Y-Axis
 * @desc Thumbnail Y-Axis offset position
 * @type number
 * @default 25 
 *
 * @param Picture Name X-Axis
 * @desc Picture Name X-Axis offset Position
 * @type number
 * @default 0
 *
 * @param Picture Name Y-Axis
 * @desc Picture Name Y-Axis offset Position
 * @type number
 * @default -32
 *
 * @param Info Visible
 * @desc activate info window
 * @type boolean
 * @default true
 *
 * @param Info X-Axis
 * @desc Info window X-Axis Position
 * @type number
 * @default 0
 *
 * @param Info Y-Axis
 ...
 * @desc Double Click Interval time
 * @type number
 * @default 10
 *
 * @help  
...
Imported.SF_PictureGallery = true;
(function(){
	SF_PictureGallery={};
	SF_PictureGallery.parameters = PluginManager.parameters('SF_PictureGallery');
	SF_PictureGallery.Pictures=JsonEx.parse(SF_PictureGallery.parameters["Pictures Info"]);
	SF_PictureGallery.Command_Menu=SF_PictureGallery.parameters["Command Menu"];
	SF_PictureGallery.Command_Word=String(SF_PictureGallery.parameters["Command Word"]);
	SF_PictureGallery.Completion_Word=String(SF_PictureGallery.parameters["Completion Word"]);
	SF_PictureGallery.Thumbnails_For_Line=Number(SF_PictureGallery.parameters["Thumbnails For Line"]);
	SF_PictureGallery.Thumbnails_X_Axis=SF_PictureGallery.parameters["Thumbnail X-Axis"];
	SF_PictureGallery
...
Game_Interpreter.prototype.pluginCommand = function(command, args) {
	...
	if (command === "enable_picture")  {$gameSystem.enable_picture(Number(args[1]),true)};
	if (command === "disable_picture")  {$gameSystem.enable_picture(Number(args[1]),false)};
	return true;
};
