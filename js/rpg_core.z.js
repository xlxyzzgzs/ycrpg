...
WindowLayer.prototype.renderCanvas = function(renderer) {
    ...
    for (var i = 0; i < this.zOrderChildren.length; i++) {
        var child = this.zOrderChildren[i];
    ...
    for (var j = 0; j < this.zOrederChildren.length; j++) {
        if (!this.zOrederChildren[j]._isWindow) {
            this.zOrderChildren[j].renderCanvas(renderer);
        }
    }
};
...
WindowLayer.prototype.renderWebGL = function(renderer) {
    ...
    for (var j = 0; j < this.zOrderChildren.length; j++) {
        if (!this.zOrderChildren[j]._isWindow) {
            this.zOrderChildren[j].renderWebGL(renderer);
        }
    }
};
